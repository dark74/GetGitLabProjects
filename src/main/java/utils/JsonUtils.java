...
public class JsonUtils {
    ...
    private static final String TAG = "JsonUtilsV2";
    ...
    private static <T> T getValueByType(final JSONObject jsonObject,
        ...
        try {
            ...
            if (type == TYPE_BOOLEAN) {
                ...
                ret = jsonObject.getIntValue(key);
    ...
    private static <T> T getValueByType(final String json,
        ...
        try {
            return getValueByType(JSON.parseObject(json), key, defaultValue, type);
        } catch (JSONException e) {
            LogUtils.e("getValueByType: " + e);
            return defaultValue;
        }
